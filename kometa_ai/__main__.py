...
def parse_args(args: List[str] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--dry-run", action="store_true",
                        help = (
    "Perform all operations without making actual changes")
    ...
    performance_group.add_argument("--profile-output", type=str,
                                help = (
    "File to save profiling data (default: profile_results.json)")
    performance_group.add_argument("--optimize-batch-size", action = (
    "store_true",
...
def send_notifications(
    ...
    subject = (
    f"Kometa-AI Processing
     Report: {len(recent_changes)} changes, {len(recent_errors)} errors"
